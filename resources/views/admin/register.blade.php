                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 bg-white">
                        <div class="form d-flex align-items-center">
                            <div class="content">
                                <form method="POST" action="{{ route('admin.register.post') }}" class="text-left form-validate">
                                    @csrf
                                    <div class="form-group-material">
                                        <input id="register-username" type="text" name="name" required 
                                               value="{{ old('name') }}" 
                                               class="input-material @error('name') is-invalid @enderror">
                                    ...
                                    <div class="form-group terms-conditions text-center">
                                        <input id="register-agree" name="terms" type="checkbox" required class="checkbox-template">
                                ...
                                <small>Already have an account? </small><a href="{{ route('admin.login') }}" class="signup">Login</a>
